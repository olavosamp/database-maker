...
## Rebuild Dataset
targetPath = dirs.images+'registroTestRev1_1'+dirs.sep
# Usage
# rebuildDatasetMulti(csv_folder, videos_folder, target_folder)
videoList, csvList, frameTotal = count.rebuildDatasetMulti(dirs.csv+"registro_de_eventos_rev1"+dirs.sep+"temp"+dirs.sep, dirs.dataset, targetPath)
